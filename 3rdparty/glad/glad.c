/*
    ...
    OpenGL loader generated by glad 0.1.28 on Mon Dec 17 18:23:38 2018.
    ...
    Commandline:
        --profile="core" --api="gl=4.3" --generator="c" --spec="gl" --no-loader --local-files --extensions="GL_ARB_fragment_program,GL_ARB_get_program_binary,GL_ARB_texture_float,GL_EXT_direct_state_access"
    Online:
        http://glad.dav1d.de/#profile=core&language=c&specification=gl&api=gl%3D4.3&extensions=GL_ARB_fragment_program&extensions=GL_ARB_get_program_binary&extensions=GL_ARB_texture_float&extensions=GL_EXT_direct_state_access
*/
